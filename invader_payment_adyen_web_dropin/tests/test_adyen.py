        ...
        with mock.patch.object(
            ...
            with MockRequest(self.env) as req:
                ...
                with self._mock_adyen_session(payable):
                    response = adyen_service.payments(payable)
            ...
            self.assertEqual(session_data.get("returnUrl"), False)
            self.assertEqual(
                session_data.get("reference"), payable._get_internal_ref()
            )
            self.assertEqual(
            ...
            self.assertEqual(
                response.get("reference"), payable._get_internal_ref()
            )
